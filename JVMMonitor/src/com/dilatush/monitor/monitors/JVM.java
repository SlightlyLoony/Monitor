...
/**
 * Implements a simple monitor for the health of a com.dilatush.monitor.monitors.JVM.
 *
...
public class JVM extends AMonitor {
    ...
    private long availableBytes;       // memory that is currently unallocated, but which the com.dilatush.monitor.monitors.JVM will try to allocate if needed...
    private long maxBytes;             // memory that the com.dilatush.monitor.monitors.JVM could use (sum of allocated and available)...
    private int  cpus;                 // number of CPUs available to the com.dilatush.monitor.monitors.JVM...
    private int  totalThreads;         // total number of active threads in the com.dilatush.monitor.monitors.JVM...
    ...
    protected void runImpl() {
        ...
        // send it!
        mailbox.send( msg );
        LOGGER.info( "Sent com.dilatush.monitor.monitors.JVM monitor message" );
    }
